/**
 * JavaScript MD5 - Minimal implementation for hashing
 * Based on RFC 1321
 */
var MD5 = (function () {
    ...
    function arrayBufferToWordArray(ab) {
        ...
        for (var i = 0; i < i8a.length; i++) {
            words[i >> 2] |= i8a[i] << ((i % 4) * 8);
        }
        return words;
    }

    return {
        hashArrayBuffer: function (ab) {
            var words = arrayBufferToWordArray(ab);
            return binl2hex(binlMD5(words, ab.byteLength * 8));
        }
    };
})();
